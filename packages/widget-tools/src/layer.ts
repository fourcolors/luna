...
export const buildWidgetToolsAddendum = (
  ...
  return (
    ...
    "- CREATE a new INTERACTIVE panel: `widget_write` for a self-contained static or obs-event widget; `mcp_app_write` when it must pull LIVE data via the curated tools (pulse, list-artifacts, memory-list, memory-search, memory-delete). Newly created widgets/apps open automatically.\n" +
