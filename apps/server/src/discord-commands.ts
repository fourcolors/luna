 ...
 *
 * Usage: bun run apps/ui-web/scripts/discord-commands.ts <command> [--dry-run]
 *
 * Commands:
...
} from "../../../packages/channels/src/adapters/discord.js"
...
const printUsage = (): void => {
  console.error(
    "usage: bun run apps/ui-web/scripts/discord-commands.ts <list|register|clear> [--dry-run]\n" +
