...
var MAX_KEY_LEN = 256;
var MAX_DISPLAY_LEN = 4096;
var MAX_DETAIL_BYTES = 16384;
var detailByteLength = (d) => {
  try {
...
function decodeDescriptorChecked(o) {
  ...
  if (o.kind.length > MAX_KEY_LEN || o.id.length > MAX_KEY_LEN)
    return fail("kind/id exceeds length limit");
  if (typeof o.title !== "string")
    return fail("title must be a string");
  if (hasControlChar(o.title))
    return fail("title must not contain control characters");
  if (o.title.length > MAX_DISPLAY_LEN)
    return fail("title exceeds length limit");
  ...
  if (o.description !== undefined) {
    ...
    if (o.description.length > MAX_DISPLAY_LEN)
      return fail("description exceeds length limit");
  ...
  if (o.argHint !== undefined) {
    ...
    if (o.argHint.length > MAX_DISPLAY_LEN)
      return fail("argHint exceeds length limit");
  ...
  if (o.detail !== undefined) {
    ...
    if (detailByteLength(o.detail) > MAX_DETAIL_BYTES)
      return fail("detail exceeds size limit");
