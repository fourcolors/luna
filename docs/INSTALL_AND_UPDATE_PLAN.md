...
- Transport: server binds 0.0.0.0 + plaintext ws:// + token auth (safe behind Tailscale, exposed off-tailnet). Add bind-to-tailnet/firewall, or rely on Tailscale + a doctor warning?
