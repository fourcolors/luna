...
- `bun run --filter '@luna/agent-cli' luna-account add --id sterling --label "Sterling" --kind anthropic --secret-ref op://cdtygwycj55n4ewcnobycow7tu/eqvivujwp6ahevhkdao2vte35a/credential`
