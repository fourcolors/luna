...
Local shell is off by default. When enabled, Luna can request commands on the
machine running the CLI. Each requested command still requires explicit approval
before execution.
