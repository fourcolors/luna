...
// luna-moon-ui [[package]] block's version may move. The fixture sandwiches our
...
describe("replaceVersion", () => {
  ...
  it("bumps ONLY luna-moon-ui in the lock, leaving neighbour crate versions put", () => {
    const out = replaceVersion(CARGO_LOCK, "lock", "0.1.0", "luna-moon-ui")
    expect(extractVersion(out, "lock", "luna-moon-ui")).toBe("0.1.0")
